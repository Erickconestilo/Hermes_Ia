...
- Tras cualquier cambio importante (seguridad, version de Hermes, decision de arquitectura, cierre operativo), anadir una linea en `learning/MEMORIA.md` de 40 a 150 caracteres, ademas del registro completo en `learning/bitacora.md`. `MEMORIA.md` es el indice corto que leen Claude, Codex y Hermes para cargar contexto rapido sin leer toda la bitacora.
