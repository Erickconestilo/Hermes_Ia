...
- producir `Content 10` sobre trabajo de campo / topografia / aprendizaje digital, usando `JUDGE.md` para aceptar solo salidas de 8/10 o mas
...
- nueve salidas reales de `Hermes Content` registradas
...
- producir piezas 10-20 del banco de contenido
