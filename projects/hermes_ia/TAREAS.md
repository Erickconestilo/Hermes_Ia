...
- Perfil `auscultacion` operativo y documentado: instancia aislada con configuración y `.env` propios, además de bot de Telegram y gateway propios; el estado vigente de proveedores y modelos está en `docs/CODEX-BRIEF.md`.
...
- proveedores y modelos finales por perfil: ver `docs/CODEX-BRIEF.md` (fuente unica)
